...
public class OrderController {
    ...
    public ResponseEntity<List<Address>> queryAddressByUserId(@PathVariable("userId") Long userId){

        List<Address> addresses = this.orderService.queryAddressByUserId(userId);
